...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7__);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2101)), "/home/olivier/workspaces/Projects/portfolio/src/app/posts/page.tsx"]}]
      },
        {
          'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2342)), "/home/olivier/workspaces/Projects/portfolio/src/app/posts/loading.tsx"],
        }
      ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7647)), "/home/olivier/workspaces/Projects/portfolio/src/app/layout.tsx"],
'head': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3311)), "/home/olivier/workspaces/Projects/portfolio/src/app/head.tsx"],
        }
      ]
      }.children;
    const metadata = [{
          ...
          path: "/home/olivier/workspaces/Projects/portfolio/src/app/layout.tsx",
        },{
          type: 'page',
          layer: 1,
          mod: () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2101)),
          path: "/home/olivier/workspaces/Projects/portfolio/src/app/posts/page.tsx",
        },];
    const pages = ["/home/olivier/workspaces/Projects/portfolio/src/app/posts/page.tsx"];
...
async function getPosts() {
    const files = fs__WEBPACK_IMPORTED_MODULE_1___default().readdirSync("./src/posts");
    const posts = files.map((file)=>{
        const slug = file.replace(".md", "");
        const fileContent = fs__WEBPACK_IMPORTED_MODULE_1___default().readFileSync("./src/posts/" + file, "utf-8");
        const parsedContent = gray_matter__WEBPACK_IMPORTED_MODULE_2___default()(fileContent);
        const postMetaData = parsedContent.data;
        return {
            slug,
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("ul", {
                children: posts.map((post)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                            ...
                            children: post.postMetaData.title
                        })
                    }, post.slug))
            })
        ]
...
var __webpack_exports__ = __webpack_require__.X(0, [227,929,702], () => (__webpack_exec__(4438)));
